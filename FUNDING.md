# Fund TRIA's Public Infrastructure

Trivian Institute is an independent 501(c)(3) nonprofit research and education organization. We develop TRIA as public-interest relational-governance infrastructure for increasingly persistent human–AI and multi-agent systems.

Sponsorship helps maintain the shared research and implementation layer: documentation, testing, reproducible evaluations, compatibility work, security hardening, issue stewardship, reference implementations, and independent validation.

[**Sponsor Trivian Institute through GitHub Sponsors**](https://github.com/sponsors/TrivianInstitute)

## Sponsorship tiers

| Amount | Tier | What it helps sustain |
|---:|---|---|
| **$10/month** | Support Relational AI Research | Routine maintenance, documentation, and public research access |
| **$50/month** | Research Sustainer | Reproducible tests, research notes, release work, and evaluation materials |
| **$250/month** | TRIA Infrastructure Sponsor | Integration examples, compatibility work, security hardening, and technical stewardship |
| **$1,000/month** | Institutional Research Sponsor | Substantial underwriting of public infrastructure, independent testing, and public progress reporting |

One-time sponsorships at these amounts are also welcome. Sponsors at the $250 and $1,000 levels may opt into public acknowledgment. Acknowledgment does not imply endorsement, validation, procurement, or research partnership.
